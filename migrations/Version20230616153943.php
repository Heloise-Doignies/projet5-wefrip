 ...
 */
final class Version20230616153943 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, user_creator_id INT DEFAULT NULL, type_event_id INT DEFAULT NULL, infos_location_id INT DEFAULT NULL, event_name VARCHAR(255) NOT NULL, event_date DATETIME DEFAULT NULL, event_description LONGTEXT NOT NULL, event_image_name VARCHAR(255) DEFAULT NULL, coordinate_lat DOUBLE PRECISION NOT NULL, coordinate_lng DOUBLE PRECISION NOT NULL, event_slug VARCHAR(255) NOT NULL, event_updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_3BAE0AA7C645C84A (user_creator_id), INDEX IDX_3BAE0AA7BC08CF77 (type_event_id), UNIQUE INDEX UNIQ_3BAE0AA75CE9B6D9 (infos_location_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
